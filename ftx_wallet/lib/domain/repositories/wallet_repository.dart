...
abstract class WalletRepository {
  ...
  Future<Either<Failure, List<FtxDepositHistory>>> getDeposits(String subaccount);
  Future<Either<Failure, List<String>>> getAllSubaccounts();
  Future<Either<Failure, List<FtxWithdrawalHistory>>> getWithdrawals(String subaccount);
}
